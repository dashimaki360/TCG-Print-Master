  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 flex flex-col items-center select-none">
      ...
      <main className="w-full max-w-6xl flex flex-col items-center gap-8">
        ...
        {!isLayoutMode ? (
          <div className="w-full flex flex-col items-center justify-center min-h-[50vh] animate-in zoom-in-95 duration-500">
            <div className="text-center space-y-2 mb-8">
              <h2 className="text-2xl font-bold text-zinc-800 dark:text-zinc-100">画像をアップロード</h2>
